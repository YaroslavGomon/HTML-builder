# Добавлено решение для всех разделов таска

## Уважаемый проверяющий, я учусь второй раз на курсе JSFE Stage1, первые 4 раздела были выполнены мной на предыдущем потоке обучения 
